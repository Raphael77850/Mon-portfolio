    ...
    <main className="min-h-screen section-padding pt-32">
      <div className="container-custom max-w-3xl space-y-8">
        ...
        <section className="glass-effect rounded-lg p-6 md:p-8 space-y-4 text-neutral leading-relaxed">
          ...
          <p>
            Aucune donnée n&apos;est vendue ou cédée à des tiers. Les
            informations sont conservées pendant une durée proportionnée au
            traitement de votre demande.
          </p>
          <p>
            Vous pouvez demander l&apos;accès, la rectification ou la
            suppression de vos données en envoyant un email à{" "}
            <a
